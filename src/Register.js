            ...
            <div className="card" style={{width:"30rem",display:"flex",alignItems:"center",justifyContent:"center"}}>
                ...
                <form onSubmit={formSubmitted}>
                    ...
                    <select name="branch" style={{ width: "400px", marginLeft: "20px" }} onChange={(e)=>setBranch(e.target.value)}>
                        ...
                        <option value="Mechanical Engineering">CSE</option>
                        <option value="Electrical Engineering">ECE</option>
                        <option value="Civil Engineering">EEE</option>
                        <option value="Chemical Engineering">AIDS</option>
                    </select>
        ...
        <div className="card" style={{width:'300px',display:'flex',flexDirection:'column'}} >
            ...
            <form>
                ...
                <option value="" selected disabled>Select your branch</option>
                    <option value="college1">IT</option>
                    <option value="college2">CSE</option>
                    <option value="college3">AIDS</option>
                    <option value="college4">AIML</option>
                    <option value="college4">ECE</option>
                    <option value="college4">EEE</option>
                </select>
                <h4>Year</h4>
                <select id="year" name="year">
                <option value="" selected disabled>Select a year</option>
                    <option value="college1">1</option>
                    <option value="college2">2</option>
                    <option value="college3">3</option>
                    <option value="college4">4</option>
                </select>
                <h4>Gender</h4>
                <input type="radio"  name="gender" value="1"/><label>Male</label>
                <input type="radio" name="gender" value="1"/><label>Female</label>
                <input type="radio" name="gender" value="1"/><label>Other</label><br/>
